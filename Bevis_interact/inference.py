...
from Abyss.hand_key.models.resnet import resnet50
from Abyss.hand_track.tracker import Tracker
from Abyss.hand_detection.utils.datasets import LoadImages, LoadStreams
from Abyss.hand_detection.utils.general import check_img_size, non_max_suppression, scale_coords, check_imshow
from Abyss.hand_detection.utils.torch_utils import select_device, time_synchronized
import numpy as np
import argparse
import os
import time
...
def parse_argument():
    ...
    parser.add_argument('--yolov5_weights', type=str, default='inference/weights/hand_weight/yolov5l_best.pt')
    # yolov5输入尺寸
